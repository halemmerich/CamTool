...
public class SortWrapper extends AbstractWrapper {
	...
	private static final String OPT_DETECT_MOVE_ALL_GROUPS_SHORT = "a";
	private static final String OPT_DETECT_MOVE_COLLECTIONS_SHORT = "c";
	private static final String OPT_DETECT_BRACKETED = "brackets";
	private static final String OPT_DETECT_SERIES = "series";
	private static final String OPT_DETECT_MOVE_ALL_GROUPS = "groups";
	private static final String OPT_DETECT_MOVE_COLLECTIONS = "collections";
	...
	public Options getOptions() {
		...
		options.addOption(Option.builder(OPT_DETECT_MOVE_COLLECTIONS_SHORT).longOpt(OPT_DETECT_MOVE_COLLECTIONS).desc("Move all detected collections into their own folder").build());
		return options;
	}
	...
	public Operation getOperation(CommandLine cmdLine) {
		...
		if (cmdLine.hasOption(OPT_DETECT_MOVE_ALL_GROUPS)) {
			sort.setMoveAllGroupsToFolder(true);
		}
		if (cmdLine.hasOption(OPT_DETECT_MOVE_COLLECTIONS)) {
